...
EMA_SIGNAL_PERIOD = 21   # EMA21 (sinyal tüneli) - high & low
...
# Emir parametreleri
LIMIT_ORDER_TIMEOUT = 5      # Saniye - limit emir bekleme süresi
LIMIT_ORDER_MAX_RETRIES = 3  # 3 deneme, 4. denemede market
